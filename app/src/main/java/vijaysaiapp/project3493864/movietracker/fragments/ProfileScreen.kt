...
import vijaysaiapp.project3493864.movietracker.DOBDateField
...
fun ProfileScreen(
    ...
    LaunchedEffect(Unit) {
        name = MovieTrackerPrefs.getUserName(context)
        dob = MovieTrackerPrefs.getUserDob(context)
        country = MovieTrackerPrefs.getUserCountry(context)
    }
    ...
    Column(
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                ...
                Button(
                    onClick = {
                        ...
                        MovieTrackerPrefs.saveUserName(context, name)
                        MovieTrackerPrefs.saveUserDob(context, dob)
                        MovieTrackerPrefs.saveUserCountry(context, country)
        ...
        Button(
            onClick = {
                MovieTrackerPrefs.clearUserSession(context)
                onLogout()
